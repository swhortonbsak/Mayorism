...
public:
    ...
    void drawImageButton (Graphics& g, Image* image, Image* labelImage,
...
public:
    ...
    LedButtonComponent(const juce::Image state_on, const juce::Image state_off)
    : ImageButton()
    {
        ...
        setLookAndFeel(&lnf);
        this->setImages(false, true, false, stateUp, 1.0, juce::Colours::transparentWhite, stateUp, 1.0, juce::Colours::transparentWhite, stateDown, 1.0, juce::Colours::transparentWhite, 0);
    };
